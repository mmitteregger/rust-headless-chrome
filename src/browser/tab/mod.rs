...
impl Tab {
    ...
    /// # }
    /// ```
    pub fn set_background_color(&self, color: protocol::dom::RGBA) -> Result<&Self> {
    ...
    pub fn set_cookies(&self, cs: Vec<network::methods::SetCookie>) -> Result<()> {
    ...
    pub fn delete_cookies(&self, cs: Vec<network::methods::DeleteCookies>) -> Result<()> {
